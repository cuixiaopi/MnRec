...
class BaseModel(nn.Module):
    ...
    def load(self, epoch, step, optimizers=None):
        ...
        save_path = "E:/NEWS/Codes/News-Recommendation/data/model_params/{}/{}_epoch{}_step{}_[hs={},topk={}].model".format(
            self.name, self.scale, epoch, step, self.his_size, self.k)
        # save_path='E:/NEWS/Codes/News-Recommendation/data/model_params/01.txt'
